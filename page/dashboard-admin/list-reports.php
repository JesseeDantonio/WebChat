...
use Index\php\classes\{ SystemAutoDisconnect, VerifyIdentification, AutoLoading };
...
VERIFY_IDENTIFICATION->isNotAdministrator($response, "../../index.php");
...
<head>
    ...
    <title>Dashboard Admin - List reports</title>
    <!--     Fonts and icons     -->
                ...
                <table class="min-w-full border-collapse block md:table">
                    <thead class="block md:table-header-group">
                        <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative">
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell w-[9rem]">User Sender</th>
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell w-[9rem]">User Concerned</th>
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell w-3/5">Message</th>
                            <th class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">Actions</th>
                        </tr>
                    </thead>
                    <tbody id="list-container" class="block md:table-row-group">
                        <?php include_once("./../../php/controller/get_list_reports_processing.php") ?>
                    </tbody>
                </table>
