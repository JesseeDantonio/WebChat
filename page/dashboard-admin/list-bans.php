...
$verifyIdentification->isNotAdministrator($response, "../../index.php");
...
<head>
    ...
    <script src="./../../js/ListBanishments.js"></script>
</head>
...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div class="w-full px-6 py-6 mx-auto">
            ...
            <div id="list-container" class="flex flex-wrap -mx-3">
                ...
                <?php include_once("./../../php/controller/get_list_bans_processing.php") ?>
    ...
    <script>
      const LIST = new ListBanishments();
